...
""".strip(),
    ...
    assert "Logged in via clawhub 0.4.2 in 37ms" in cast(
...
""".strip(),
    ...
    assert (
        ...
        == "Logged in via clawhub 0.9.0 in 4200ms. Installed automatically."
    )
...
const translations = {
    ...
    "settings.clawhub.testing_message": "Logging in to ClawHub with the configured token...",
    "settings.clawhub.probe_failed": "ClawHub probe failed: {error}",
    "settings.clawhub.probe_success": "Logged in via {version} in {latency_ms}ms",
    "settings.clawhub.probe_success_after_install": "Logged in via {version} in {latency_ms}ms. Installed automatically.",
