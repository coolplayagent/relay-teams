...
def test_injection_manager_isolated_by_recipient() -> None:
    ...
    mgr.enqueue('run1', 'a1', InjectionSource.SUBAGENT, 'm1', sender_instance_id='b1', sender_role_id='generalist')
    mgr.enqueue('run1', 'a2', InjectionSource.SUBAGENT, 'm2', sender_instance_id='b1', sender_role_id='generalist')
