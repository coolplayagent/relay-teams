...
class RunEventType(str, Enum):
    ...
    EXEC_SESSION_STARTED = "exec_session_started"
    EXEC_SESSION_UPDATED = "exec_session_updated"
    EXEC_SESSION_COMPLETED = "exec_session_completed"
    EXEC_SESSION_STOPPED = "exec_session_stopped"
