...
class ServerContainer:
    def __init__(
        ...
        *,
        ...
        self.background_terminal_repo: BackgroundTerminalRepository = (
            BackgroundTerminalRepository(runtime.paths.db_path)
        )
        ...
        if manage_runtime_state:
            ...
            _ = self.background_terminal_repo.mark_transient_terminals_interrupted()
        ...
        self.background_terminal_manager = BackgroundTerminalManager(
            repository=self.background_terminal_repo,
        ...
        self.external_acp_session_manager = ExternalAcpSessionManager(
            ...
            background_terminal_manager=self.background_terminal_manager,
        ...
        self.session_service: SessionService = SessionService(
            ...
            background_terminal_repo=self.background_terminal_repo,
            run_state_repo=self.run_state_repo,
            run_event_hub=self.run_event_hub,
            active_run_registry=self.active_run_registry,
            event_log=self.event_log,
    ...
    async def stop(self) -> None:
        ...
        await self.background_terminal_manager.close()
        return None
