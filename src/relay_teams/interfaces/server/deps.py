...
from relay_teams.hooks import HookConfigService
...
def get_hook_config_service(request: Request) -> HookConfigService:
    return get_container(request).hook_config_service
