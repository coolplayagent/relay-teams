...
- **Structured Summary:** [`video-transcripts-summary.md`](cloud-next-2026/video-transcripts-summary.md) — organized by section, with product specs, customer stories, speaker names, and key quotes
- **Raw Transcripts:** [`transcripts/`](cloud-next-2026/transcripts/) — English SRT + plain text from YouTube auto-captions
