# Relay Teams Documentation

This directory is organized by documentation purpose and runtime module.
...
- [DelegationPlanner dynamic DAG](modules/agents/delegation-planner-dynamic-dag-spec.md)
...
- [Runtime guardrails](modules/security/runtime-guardrails-spec.md)
...
- [Lessons learned roadmap](research/lessons-learned-2026.md)
- [Agent capability research](research/agent-capabilities/)
- [AI market research](research/ai-market/)
- [AI-native company research](research/ai-native-company/)
- [Brainstorming notes](research/brainstorming/)
- [Codex analysis](research/codex/)
- [Coding agent orchestration](research/coding-agent-orchestration/)
- [Formal verification](research/formal-verification/)
- [Google Cloud Next research](research/google-cloud-next/)
- [Harness engineering](research/harness/)
- [MAS and protocol research](research/mas/)
- [Research presentations](research/presentations/)
- [SDD research](research/sdd/)
- [SPDD research](research/spdd/)
