...
- the schema is already documented in `docs/core/database-schema.md`
- skill routing already proves the architectural pattern in `docs/modules/skills/skill-routing-design.md`
...
This follows the existing durable memory boundary described in `docs/modules/memory/role-workspace-memory-design.md`: role memory is shared by the same `role_id + workspace_id` pair across sessions.
...
- `docs/modules/memory/role-workspace-memory-design.md`
- `docs/modules/skills/skill-routing-design.md`
- `docs/core/database-schema.md`
